...
makeCube.paint = function(bucket) {
	var area = this.area();
	return bucket.use(area) && (this.color = bucket.color);	
}
...
var sizes = [1,2,3,3];
function makeWhiteCube(size) {
    return makeCube(size,'white');
}
var cubes = sizes.map(makeWhiteCube);
cubes
cubes[0].paint(redPaintBucket);
...
//FIG: 2014-05-31_0016.jpg
//FIG: 2014-05-31_0017.jpg
...
function factory(inits) {
	var instance = {};
	instance.sharedMethod = factory.method;
	instance.personalMethod = function() {
